...
C --> E[Facteurs médicaux]
C --> F[Facteurs environnementaux]
C --> G[Profil sensoriel et communication]

E --> H[Interventions médicales ciblées]
F --> I[Adaptations environnementales]
G --> J[Soutien et interventions non-pharmacologiques]
